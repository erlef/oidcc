...
alias_name = case System.argv() do
  [alias_name] -> [alias_name]
  _other -> Mix.raise("""
  The script must be called with the alias argument
  """)
end
  ...
  Supervisor.start_link(
    [
      ...
      {Oidcc.ProviderConfiguration.Worker,
       %{issuer: "https://www.certification.openid.net/test/a/#{alias_name}/", name: :config_worker}}
    ],
